...
Built with [Kaplay](https://kaplayjs.com/) (the successor to Kaboom.js) and [Vite](https://vite.dev/).

The overall idea — a developer portfolio you walk around in as a 2D game — is
inspired by [JSLegendDev's 2D portfolio](https://github.com/JSLegendDev/2d-portfolio-kaboom)
and the accompanying [freeCodeCamp course](https://www.freecodecamp.org/news/create-a-developer-portfolio-as-a-2d-game/).
No code or assets from that project are used here.
