      ...
      children: [
        ...
        },
        {
          ...
          body: [
            ...
            "",
            `![Live process tree](${asset("assets/shots/process-monitor1.png")})`,
            `![Live process tree](${asset("assets/shots/process-monitor2.png")})`,
            `![Live process tree](${asset("assets/shots/process-monitor3.png")})`,
        ...
        },
        {
          ...
          body: [
            ...
            "",
            `![Login page](${asset("assets/shots/noted1.png")})`,
            `![Note editing](${asset("assets/shots/noted2.png")})`,
        ...
        },
        {
          ...
          type: "text",
          body: [
            "# TuneType - Music-Based Typing Game",
            "",
            ...
            "",
            `![TuneType](${asset("assets/shots/TuneType1.png")})`,
        ...
        },
        {
          ...
          body: [
            ...
            "",
            "All of it is resolution-independent and multi-monitor aware, so the same code runs across displays.",
            "",
            `![Set Reroller](${asset("assets/shots/SetReroller.png")})`,
            "**Stack:** AutoHotkey v2 · Tesseract OCR · GDI+ · WinHTTP",
          ].join("\n"),
        },
        {
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          type: "image",
          src: asset("assets/shots/screenshot2.png"),
        },
      ],
    },
